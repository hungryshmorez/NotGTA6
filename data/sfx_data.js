    ...
    sfx_packs: [
      {
        id: 'core_ui',
        items: [
          { id: 'cash',            path: 'assets/audio/notification.mp3', gain: 0.8, tags: ['sfx', 'ui'] },
          { id: 'ui_error',        path: 'assets/audio/click.mp3', gain: 0.7, tags: ['sfx', 'ui'] },
          { id: 'ui_click',        path: 'assets/audio/click.mp3', gain: 0.5, tags: ['sfx', 'ui'] },
          { id: 'ui_confirm',      path: 'assets/audio/notification.mp3', gain: 0.6, tags: ['sfx', 'ui'] },
          { id: 'notification',    path: 'assets/audio/notification.mp3', gain: 0.7, tags: ['sfx', 'ui'] }
        ]
      },
      {
        id: 'radio_hardware',
      ...
      },
      {
        id: 'ambient_loops',
        items: [
          { id: 'city_ambience',   path: 'assets/audio/city_ambience.mp3', gain: 0.35, loop: true, tags: ['ambient'] },
